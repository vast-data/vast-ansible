...
DOCUMENTATION = r"""
---
module: vms_network_settings_info
...
EXAMPLES = r"""
- name: List vms_network_settings
  vastdata.vms.vms_network_settings_info:
    vms:
      host: vast-vms.example.com
      token: "{{ vast_token }}"
    vms_id: 1
  register: vms_network_settings_result
"""
...
class VmsNetworkSettingsInfo(SubEndpointInfoResource):
    parent_resource = "vms"
    sub_path = "network_settings"
    path_has_id = True
    return_key = "vms_network_settings"
    filter_fields = set()
...
def main() -> None:
    ...
    try:
        resource = VmsNetworkSettingsInfo(module)
        resource.run()

...
#
# Sub-endpoint module: quotagroups/reset_grace_period
...
DOCUMENTATION = r"""
---
module: quotagroup_reset_grace_period
short_description: Manage quotagroup reset grace period
description:
  - Manage quotagroup reset grace period.
...
EXAMPLES = r"""
- name: Manage quotagroup reset grace period
  vastdata.vms.quotagroup_reset_grace_period:
    vms:
...
class QuotagroupResetGracePeriod(SubEndpointResource):
    parent_resource = "quotagroups"
    sub_path = "reset_grace_period"
    path_has_id = True
...
def main() -> None:
    ...
    try:
        resource = QuotagroupResetGracePeriod(module)
        resource.run()

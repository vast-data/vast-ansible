...
#
# Sub-endpoint module: vms/remove_client_certificate
...
DOCUMENTATION = r"""
---
module: vms_remove_client_certificate
short_description: Manage vms remove client certificate
description:
  - Manage vms remove client certificate.
...
EXAMPLES = r"""
- name: Manage vms remove client certificate
  vastdata.vms.vms_remove_client_certificate:
    vms:
...
class VmsRemoveClientCertificate(SubEndpointResource):
    parent_resource = "vms"
    sub_path = "remove_client_certificate"
    path_has_id = True
...
def main() -> None:
    ...
    try:
        resource = VmsRemoveClientCertificate(module)
        resource.run()

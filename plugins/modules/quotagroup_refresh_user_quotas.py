...
#
# Sub-endpoint module: quotagroups/refresh_user_quotas
...
DOCUMENTATION = r"""
---
module: quotagroup_refresh_user_quotas
short_description: Manage quotagroup refresh user quotas
description:
  - Manage quotagroup refresh user quotas.
...
EXAMPLES = r"""
- name: Manage quotagroup refresh user quotas
  vastdata.vms.quotagroup_refresh_user_quotas:
    vms:
...
class QuotagroupRefreshUserQuotas(SubEndpointResource):
    parent_resource = "quotagroups"
    sub_path = "refresh_user_quotas"
    path_has_id = True
...
def main() -> None:
    ...
    try:
        resource = QuotagroupRefreshUserQuotas(module)
        resource.run()

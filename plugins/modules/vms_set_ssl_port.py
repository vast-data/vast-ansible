...
#
# Sub-endpoint module: vms/set_ssl_port
...
DOCUMENTATION = r"""
---
module: vms_set_ssl_port
short_description: Manage vms set ssl port
description:
  - Manage vms set ssl port.
...
EXAMPLES = r"""
- name: Manage vms set ssl port
  vastdata.vms.vms_set_ssl_port:
    vms:
...
class VmsSetSslPort(SubEndpointResource):
    parent_resource = "vms"
    sub_path = "set_ssl_port"
    path_has_id = True

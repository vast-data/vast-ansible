...
#
# Sub-endpoint module: vms/set_certificate
...
DOCUMENTATION = r"""
---
module: vms_set_certificate
short_description: Manage vms set certificate
description:
  - Manage vms set certificate.
...
EXAMPLES = r"""
- name: Manage vms set certificate
  vastdata.vms.vms_set_certificate:
    vms:
...
class VmsSetCertificate(SubEndpointResource):
    parent_resource = "vms"
    sub_path = "set_certificate"
    path_has_id = True
...
def main() -> None:
    ...
    try:
        resource = VmsSetCertificate(module)
        resource.run()

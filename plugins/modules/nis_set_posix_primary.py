...
#
# Sub-endpoint module: nis/set_posix_primary
...
DOCUMENTATION = r"""
---
module: nis_set_posix_primary
short_description: Manage nis set posix primary
description:
  - Manage nis set posix primary.
  - Supports check_mode and diff.
version_added: "1.0.0"
options:
  nis_id:
    description: "ID of the nis"
    type: int
    required: true
author:
  - VAST Data (@vastdata)
...
EXAMPLES = r"""
- name: Manage nis set posix primary
...
ARGUMENT_SPEC = {
    ...
    "nis_id": {"required": True, "type": "int"},
}
# END AUTOGENERATED ARGUMENT_SPEC


# BEGIN AUTOGENERATED RESOURCE_CLASS
class NisSetPosixPrimary(SubEndpointResource):
    parent_resource = "nis"
    sub_path = "set_posix_primary"
    path_has_id = True
    supported_operations = frozenset({CrudCapability.UPDATE})
    parent_id_param = "nis_id"
...
def main() -> None:
    ...
    try:
        resource = NisSetPosixPrimary(module)
        resource.run()

...
#
# Sub-endpoint module: vms/login_banner
...
DOCUMENTATION = r"""
---
module: vms_login_banner
short_description: Query VMS login banner
description:
  - Query VMS login banner.
...
EXAMPLES = r"""
- name: Query VMS login banner
  vastdata.vms.vms_login_banner:
    vms:
...
class VmsLoginBanner(SubEndpointResource):
    parent_resource = "vms"
    sub_path = "login_banner"
    path_has_id = True
...
def main() -> None:
    ...
    try:
        resource = VmsLoginBanner(module)
        resource.run()

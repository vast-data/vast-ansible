...
#
# Sub-endpoint module: vms/reset_certificate
...
DOCUMENTATION = r"""
---
module: vms_reset_certificate
short_description: Manage vms reset certificate
description:
  - Manage vms reset certificate.
...
EXAMPLES = r"""
- name: Manage vms reset certificate
  vastdata.vms.vms_reset_certificate:
    vms:
...
class VmsResetCertificate(SubEndpointResource):
    parent_resource = "vms"
    sub_path = "reset_certificate"
    path_has_id = True
...
def main() -> None:
    ...
    try:
        resource = VmsResetCertificate(module)
        resource.run()

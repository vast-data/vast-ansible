...
#
# Sub-endpoint module: blobexpansions/delete
...
DOCUMENTATION = r"""
---
module: blobexpansion_delete
short_description: Manage blobexpansion delete
description:
  - Manage blobexpansion delete.
...
EXAMPLES = r"""
- name: Manage blobexpansion delete
  vastdata.vms.blobexpansion_delete:
    vms:
...
class BlobexpansionDelete(SubEndpointResource):
    parent_resource = "blobexpansions"
    sub_path = "delete"
    path_has_id = False
    supported_operations = frozenset({CrudCapability.DELETE})
    delete_body_fields = {"database_name", "source_column_name", "table_name", "tenant_id"}  # Sent in JSON body on DELETE
...
def main() -> None:
    ...
    try:
        resource = BlobexpansionDelete(module)
        resource.run()

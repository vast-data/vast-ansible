...
DOCUMENTATION = r"""
---
module: permissions_info
short_description: List VAST Permission resources
description:
  - List VAST Permission resources.
...
- name: List permissions filtered by name
  vastdata.vms.permissions_info:
    vms:
      host: vast-vms.example.com
      token: "{{ vast_token }}"
    name: example-value
  register: filtered_permissions
"""
...
changed:
  ...
  returned: always
permissions:
  description: List of matching permissions resources.
  type: list
  elements: dict
  returned: always
  sample: []
...
ARGUMENT_SPEC: Dict[str, Any] = {
    ...
    "codename": {"type": "str", "default": None},
    "id": {"type": "int", "default": None},
    "name": {"type": "str", "default": None},
    "permission_type": {"type": "str", "default": None},
...
class PermissionInfoResource(BaseInfoResource):
    """Read-only list manager for Permission."""

    resource_name = "permissions"
    return_key = "permissions"
    filter_fields = {"codename", "id", "name", "permission_type", "realm"}
...
def main() -> None:
    ...
    try:
        resource = PermissionInfoResource(module)
        resource.run()

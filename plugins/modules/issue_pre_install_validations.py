...
#
# Sub-endpoint module: issues/pre_install_validations
...
DOCUMENTATION = r"""
---
module: issue_pre_install_validations
short_description: Manage issue pre install validations
description:
  - Manage issue pre install validations.
...
EXAMPLES = r"""
- name: Manage issue pre install validations
  vastdata.vms.issue_pre_install_validations:
    vms:
...
changed:
  ...
  type: bool
  returned: always
issue_pre_install_validations:
  description: The list of sub-resources.
  type: list
  returned: always
"""
...
class IssuePreInstallValidations(SubEndpointResource):
    parent_resource = "issues"
    sub_path = "pre_install_validations"
    path_has_id = False
    supported_operations = frozenset({CrudCapability.READ})
    returns_list = True  # GET returns a top-level array
...
def main() -> None:
    ...
    try:
        resource = IssuePreInstallValidations(module)
        resource.run()

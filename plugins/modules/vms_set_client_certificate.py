...
#
# Sub-endpoint module: vms/set_client_certificate
...
DOCUMENTATION = r"""
---
module: vms_set_client_certificate
short_description: Manage vms set client certificate
description:
  - Manage vms set client certificate.
...
EXAMPLES = r"""
- name: Manage vms set client certificate
  vastdata.vms.vms_set_client_certificate:
    vms:
...
ARGUMENT_SPEC = {
    ...
    "ssl_client_certificate": {"type": "str", "default": None, "no_log": True},
    "ssl_client_keyfile": {"type": "str", "default": None, "no_log": True},
}
# END AUTOGENERATED ARGUMENT_SPEC


# BEGIN AUTOGENERATED RESOURCE_CLASS
class VmsSetClientCertificate(SubEndpointResource):
    parent_resource = "vms"
    sub_path = "set_client_certificate"
    path_has_id = True
...
def main() -> None:
    ...
    try:
        resource = VmsSetClientCertificate(module)
        resource.run()

...
#
# Sub-endpoint module: callhomeconfigs/send
...
DOCUMENTATION = r"""
---
module: callhomeconfig_send
short_description: Manage callhomeconfig send
description:
  - Manage callhomeconfig send.
...
EXAMPLES = r"""
- name: Manage callhomeconfig send
...
class CallhomeconfigSend(SubEndpointResource):
...
def main() -> None:
    ...
    try:
        resource = CallhomeconfigSend(module)
        resource.run()

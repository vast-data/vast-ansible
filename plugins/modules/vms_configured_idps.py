...
#
# Sub-endpoint module: vms/configured_idps
...
DOCUMENTATION = r"""
---
module: vms_configured_idps
short_description: Query VMS configured identity providers
description:
  - Query VMS configured identity providers.
...
EXAMPLES = r"""
- name: Query VMS configured identity providers
...
class VmsConfiguredIdps(SubEndpointResource):
    parent_resource = "vms"
...
def main() -> None:
    ...
    try:
        resource = VmsConfiguredIdps(module)
        resource.run()

#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Unit tests for callhomeconfigs module."""
...
class TestNormalize:
    ...
    def test_normalize_removes_read_only_fields(self):
        ...
        resource = {"id": 1, "bundle_enabled": "test"}
        overrides = get_overrides("callhomeconfigs")
    ...
    def test_normalize_preserves_writable_fields(self):
        ...
        resource = {"bundle_enabled": "test-value"}
        overrides = get_overrides("callhomeconfigs")
        result = normalize_resource(resource, overrides)
        assert "bundle_enabled" in result
...
class TestComputePatch:
    ...
    def test_no_changes(self):
        ...
        current = {"bundle_enabled": "test"}
        desired = {"bundle_enabled": "test"}
        overrides = get_overrides("callhomeconfigs")
    ...
    def test_detects_change(self):
        ...
        current = {"bundle_enabled": "old"}
        desired = {"bundle_enabled": "new"}
        overrides = get_overrides("callhomeconfigs")
        patch = compute_patch(current, desired, overrides)
        assert patch == {"bundle_enabled": "new"}

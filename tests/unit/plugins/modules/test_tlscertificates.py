#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Unit tests for tlscertificates module."""
...
class TestNormalize:
    ...
    def test_normalize_removes_read_only_fields(self):
        ...
        resource = {"id": 1, "ca_certificate_name": "test"}
        overrides = get_overrides("tlscertificates")
    ...
    def test_normalize_preserves_writable_fields(self):
        ...
        resource = {"ca_certificate_name": "test-value"}
        overrides = get_overrides("tlscertificates")
        result = normalize_resource(resource, overrides)
        assert "ca_certificate_name" in result
...
class TestComputePatch:
    ...
    def test_no_changes(self):
        ...
        current = {"ca_certificate_name": "test"}
        desired = {"ca_certificate_name": "test"}
        overrides = get_overrides("tlscertificates")
    ...
    def test_detects_change(self):
        ...
        current = {"ca_certificate_name": "old"}
        desired = {"ca_certificate_name": "new"}
        overrides = get_overrides("tlscertificates")
        patch = compute_patch(current, desired, overrides)
        assert patch == {"ca_certificate_name": "new"}
